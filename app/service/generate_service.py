from app.core.prompt.single_choice_quiz_generate_prompt import (
    single_choice_quiz_generation_prompt,
)
from app.core.prompt.text_quiz_generate_prompt import text_quiz_generation_prompt
from app.core.util.ai_manager import AIManager
from app.dto.request.generate_single_choice_quiz_request import (
    GenerateSingleChoiceQuizRequest,
)
...
from app.dto.response.generate_single_choice_quiz_response import (
    GenerateSingleChoiceQuizResponse,
)
